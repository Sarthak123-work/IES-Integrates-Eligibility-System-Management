...
public class User implements CustomeUserService {
	...
	public User(Integer userId,
			...
			@NotNull(message = "Phone number required") @Digits(integer = 10, fraction = 0, message = "Phone number must be 10 digits") Long phno,
			@NotBlank(message = "Password is required") @Size(min = 6, message = "Password must be at least 6 characters") String pwd,
			String pwdUpdated, @NotNull(message = "Role is required") Role role, LocalDateTime createdDate,
